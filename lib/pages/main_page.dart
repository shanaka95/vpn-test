...
class Location {
  ...
  Location({this.country, this.city, this.isp, this.ip});
...
//  }
  ...
  void initState() {
    FlutterVpn.prepare();
    a= Location.fromJson(json.decode('{"country":"Loading..","city":"","isp":"","as":"","query":"Loading.."}'));
    fetchPost();
  ...
  Future<void> fetchPost() async {
    ...
    if (response.statusCode == 200) {
      ...
      a= Location.fromJson(json.decode(response.body));
      print(a.country+" 1111111111111111111111111111111111111111111");
    } else {
...
//        ),
//      );
  Widget serverConnection2(context) {
    return  new Row(
        ...
        children: <Widget>[
          ...
          Text(
            country,
            style: TextStyle(
                color: Colors.white, fontFamily: "Montserrat-SemiBold",fontSize: 16.0),
          ),
